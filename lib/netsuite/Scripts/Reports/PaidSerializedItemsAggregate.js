...
define([
  ...
  function runQuery() {
    var sql =
      ...
      WITH base AS (\
        ...
        SELECT\
          so_id, so_tranid, customer_id, hold_till, so_line, item_sku, item_name, itemtype,\
  ...
  function onRequest(ctx) {
    ...
    var rawRows = runQuery();
    var split = splitRowsByHoldTill(rawRows);
    var rows = split.visibleRows;
    var skippedHoldTillRows = split.skippedHoldTillRows;
